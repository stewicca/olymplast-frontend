  ...
  <div class="layout-swiper-navigation relative w-full">
    <div class="layout mb-24 mt-12 w-full lg:mt-16">
      ...
      >
        <!-- Articles -->
        <SwiperSlide
          v-for="data in data.data.value.data.data"
          :key="data.title"
        >
      ...
      <div class="mt-6 flex justify-center">
        <NuxtLink
          to="/blog"
          class="cursor-pointer rounded-md bg-[#4197CE] px-2 py-1 text-white hover:bg-[#2A6A9D]"
    ...
    <div
      class="custom-prev-3 absolute left-0 top-[45%] z-10 flex h-12 items-center justify-center rounded-r-lg bg-[#4197CE] bg-opacity-50 text-white hover:bg-opacity-80"
    >
      <svg
        fill="#ffffff"
    ...
    <div
      class="custom-next-3 absolute right-0 top-[45%] z-10 flex h-12 items-center justify-center rounded-l-lg bg-[#4197CE] bg-opacity-50 text-white hover:bg-opacity-80"
    >
      <svg
        fill="#ffffff"
        viewBox="0 0 1024 1024"
